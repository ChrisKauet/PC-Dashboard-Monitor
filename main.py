...
Launches sensor collection in background + system tray icon + browser dashboard.
"""
import os
import sys
import time
...
try:
    ...
    input("Error: Install pystray + pillow. Press Enter to exit...")
    sys.exit(1)
...
def open_api():
    webbrowser.open("http://localhost:8080/api/sensors")
...
def main():
    ...
    menu = pystray.Menu(
        ...
        pystray.MenuItem("View Local API", open_api),
